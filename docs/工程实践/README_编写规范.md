...
- [国创技术报告](../比赛/国创/国创技术报告.md) — 第 5 章证据版 E3/E4 素材源（执行摘要 / 创新点 T1-T3 / 评测口径）
...
| E4 创新点对照 | 3 个创新点 ×（一句话价值 + 与 docs/调研对标/标杆项目对标分析 差异）+ 文档链接 | 创新优化性 |
...
> 分工提示：本项目已有 `docs/比赛/国创/国创技术报告.md` 承担"技术报告"主载体，其执行摘要/创新点/评测可直接复用为 E3、E4 素材，README 证据版定位为**轻量技术附件**，不重复写长报告。
...
| 3 | 跑测试（验证口径） | 可复制即跑的精确命令 + **期望输出**（如 `835 passed, 7 deselected`）+ 说明哪些用例需要真实 API key（`-m "not llm_api"`） |
